...
def correct_from_glorysclim(du):
    """Return the corrected grounding position from surface Lat/Lon & Glory Climatology"""
    # Durations
    ascent_duration = int((du.PROFILE_DATE - du.GROUNDING_DATE).values)/(1e9) #seconds
    drift_duration = 2000 #seconds
    # Displacements [meters] = -1 * duration * velocity
...
# Add corrected position to netcdf
